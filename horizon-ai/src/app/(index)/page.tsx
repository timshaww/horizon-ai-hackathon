					...
					<div className='max-w-3xl mx-auto text-center'>
						...
						<motion.div custom={3} variants={fadeUpVariants} initial='hidden' animate='visible' className='max-w-md mx-auto'>
							...
							{/* <div className='w-full justify-center flex'>
								<div className='border border-[#146C94] rounded-xl flex flex-col w-fit'>
									<img src='images/mockup/Office.webp' alt='' className='rounded-t-xl size-80' />
									<div className='flex py-3 items-center w-full justify-center bg-[#f1ede7] rounded-b-xl'>
										<Link
											href='/rooms'
