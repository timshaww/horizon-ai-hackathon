            ...
            <div className="hidden md:grid md:grid-cols-4 md:gap-8">
              {footerSections.map((section) => (
                <div key={section.title}>
                  <h3 className="text-sm font-semibold text-[#146C94] uppercase tracking-wider">
                    {section.title}
                  </h3>
            ...
            <div className="mt-12 pt-8 border-t border-[#AFD3E2]">
              <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                ...
                <div className="flex flex-col items-center gap-4 md:flex-row md:gap-6">
                  <Link 
                    href="/" 
                    className="text-xl font-bold text-[#146C94] hover:opacity-90 transition-opacity"
                  >
                    <Image 
                  ...
                  <p className="text-sm text-[#146C94]/70">
                    © {currentYear} TherapyAI. Making mental healthcare more accessible.
                  </p>
                </div>
